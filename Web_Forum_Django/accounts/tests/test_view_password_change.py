...
class SuccessfulPasswordChangeTests(PasswordChangeTestCase):
    ...
    def test_password_changed(self):
        ...
        '''
        # method make sure we have the latest state of the data. It forces Django to query the database again to update the data.
        #  We have to do it because the change_password view update the password in the database. 
