...
'''
class we defined to be reused across the other test cases. It's just the basic setup, creating users, topic, boards, and so on.
'''
...
'''
test if the view is protected with the @login_required decorator. That is if only authenticated users can access the edit page.
'''
...
'''
creates a new user, different from the one who posted and tries to access the edit page. 
